    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $.each(data, function (index, story) {
          storiesList.append(
            `<div class="mb-3 story-div">
                  <h3 class="text-fonts">${story.title}</h3>
                  <div class="text-fonts">${story.content}</div>
                  <div>
                      <button class="create-btn btn btn-info btn-sm mr-2 btn-edit" data-id="${story.id}">Edit</button>
